...
class ModelTrainer(object):
    ...
    def generate(self, max_score=0, epoch=0, epoch_max=0):
                    ...
                    if isDiease:
                        ...
                        if self.args.only_gen:
                            ...
                            # if False:
                                ...
                                label_index = torch.argmax(token_logits, -1).item()
                                flag = '生成v2'
                                # gold_index = disease_ids.index(label)
                                # if gold_index in dx_index:
                                #     mc_acc += 1
                                # break
        ...
        logger.info('epoch {}:评估结果\n :疾病预测准确率为:{}, 症状问询召回率为:{}'.format(epoch,mc_acc/len(testdata), imp_acc/imp_all))
...
def main():
    ...
    for i in range(200):
        ...
        # trainer.model.eval()
        max_score, epoch_max = trainer.generate(max_score, i)
    print(epoch_max)
